...
using SME.Portal.DynamicEntityPropertyValues.Dto;

namespace SME.Portal.DynamicEntityProperties
{
    [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : PortalAppServiceBase, IDynamicEntityPropertyValueAppService
    {
        ...
        [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue_Create)]
        ...
        [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue_Edit)]
        ...
        [Authorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue_Delete)]
