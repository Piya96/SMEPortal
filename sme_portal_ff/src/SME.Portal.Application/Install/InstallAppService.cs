...
using SME.Portal.Migrations.Seed;
using SME.Portal.Migrations.Seed.Host;
...
namespace SME.Portal.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PortalAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PortalDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{PortalConsts.ConnectionStringName}", constring);
        }
