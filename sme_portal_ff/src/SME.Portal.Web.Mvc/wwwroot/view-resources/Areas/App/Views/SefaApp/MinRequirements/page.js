...
(function (page) {
    ...
    class MinRequirementsPage extends app.wizard.page.Base {
        ...
        getDocuments(cb) {
            ...
            //let productId = '6262851b4a757c7ed1f3097f';// Youth Channel(OK)
            //let productId = '626284c39771fd971fa548c2';// Direct lending sub program(Not found)
            //let productId = '626284e1f8ecc0f40b8edf00';// TREP(OK)
            //let productId = '62628008f9fce6eea1f8f611';// RFI Business Loans(OK)
            //let productId = '6266620183b96943ddf85151';// Wholesale lending(OK)
            //let productId = '62628286639e7b9d112e6666';//(OK)
            //let productId = '6266644706b2c31359cd102f';// Revolving loan(OK)
            //let productId = '626663ff9d63e9cf83e4126a';// Asset finance(OK)
            //let productId = '626663b9b8ac31dfde290063';// Bridging loan(OK)
            //let productId = '63232c9e0bd9ef3f1a8e3b82';// Purchase order(OK)
            //let productId = '626662df990a95913a1aa780';//Direct lending(OK)
            //let productId = '62628556e79a488f50c98bc2';// Veteran(OK)
            //let productId = '62666292443c96e336e77adb';// Veteran(OK)
            //let productId = '62666479ae31305e9e16f2fe';// Term loan(OK)
            //let productId = '626661851c7472bd5d1ee51c';// Godisa loans(OK)
            //let productId = '626282d9530062eea92b5b18';// Co-op dev fund(OK)
            //let productId = '626282bbbf0a95435552dbeb';// Micro finance()
