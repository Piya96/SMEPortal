...
using SME.Portal.Test.Base.TestData;
...
namespace SME.Portal.Test.Base
{
    ...
    /// Provides methods to easily work with <see cref="PortalDbContext"/>.
    /// </summary>
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        {
            void NormalizeDbContext(PortalDbContext context)
            {
        ...
        protected TResult UsingDbContext<TResult>(Func<PortalDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<PortalDbContext, Task<TResult>> func)
        {
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<PortalDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<PortalDbContext, Task<TResult>> func)
        {
            TResult result;
