...
using SME.Portal.Commands;
using SME.Portal.Core.Threading;
using SME.Portal.Models.NavigationMenu;
using SME.Portal.Services.Navigation;
using SME.Portal.ViewModels.Base;
using Plugin.Media;
...
using SME.Portal.ApiClient;
using SME.Portal.Controls;
using SME.Portal.Dto;
using SME.Portal.Extensions;
using SME.Portal.Localization;
using SME.Portal.UI;
using SME.Portal.UI.Assets;
using SME.Portal.Views;
using DependencyResolver = SME.Portal.Core.Dependency.DependencyResolver;

namespace SME.Portal.ViewModels
{
