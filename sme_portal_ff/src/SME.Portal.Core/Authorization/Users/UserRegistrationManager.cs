...
{
    public class UserRegistrationManager : PortalDomainServiceBase
    {
        ...
        public async Task<User> RegisterAsync(string name, string surname, string emailAddress, string userName, string plainPassword, bool isEmailConfirmed, string emailActivationLink, string origin = "", string phoneNumber = "", string source = "")
        {
            CheckForTenant();
            ...
            var user = new User
            {
                ...
                EmailConfirmationSentDateUtc = DateTime.UtcNow,
                Origin = origin,
            ...
            if (!user.IsEmailConfirmed)
            {
                ...
                if (!string.IsNullOrEmpty(source) && source == "BS")
                {
                    await _userEmailer.SendEmailActivationLinkForBusinessSupportAsync(user, emailActivationLink, source);
                }
                else
                { 
