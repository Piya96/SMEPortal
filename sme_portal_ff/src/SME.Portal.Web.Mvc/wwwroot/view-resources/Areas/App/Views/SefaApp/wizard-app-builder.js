...
(function (builder) {
    ...
    builder.init = function (model, cb = null) {
        ...
        pages.push({
            ...
            validator: app.wizard.validation.getDisclaimerValidator('id-div-disclaimer')
        });

        pages.push({
            page: app.wizard.page.getMandateFitPage('id-div-mandate-fit'),
            validator: app.wizard.validation.getMandateFitValidator('id-div-mandate-fit')
        });

        pages.push({
            page: app.wizard.page.getFundingRequirementsPage('id-div-funding-requirements'),
            validator: app.wizard.validation.getFundingRequirementsValidator('id-div-funding-requirements')
        });

        pages.push({
            page: app.wizard.financialInfo.page.create('id-div-legal-questions'),
            validator: app.wizard.financialInfo.validation.create('id-div-legal-questions')
        });

        pages.push({
            //page: app.wizard.page.getSupportDocumentsPage('id-div-support-documents'),
            //validator: app.wizard.validation.getSupportDocumentsValidator('id-div-support-documents')
            page: app.wizard.minRequirements.page.create('div-key-things'),
            validator: app.wizard.minRequirements.validation.create('div-key-things')
        });

        pages.push({
            page: app.wizard.page.getSummaryPage('id-div-summary'),
            validator: app.wizard.validation.getSummaryValidator('id-div-summary')
        });
        ...
        let appController = app.wizard.controller.getAppController('kt_wizard_funding', 'funding-application-wizard');
        appController.init({
            'pages': pages,
            'common': common
        }, cb);
