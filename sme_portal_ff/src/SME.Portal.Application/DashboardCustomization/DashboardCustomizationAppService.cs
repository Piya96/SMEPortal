...
using SME.Portal.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace SME.Portal.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : PortalAppServiceBase, IDashboardCustomizationAppService
    {
