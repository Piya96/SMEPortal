...
function fundingWizardLoadControls() {
    ...
    (function (controls) {
        ...
        const ownerscontribution = 'ownerscontribution';
        ...
        const cipcRegistrationDoc = '5aaf6d123a022727ec3b587a';
        const cipcAnnualReturn = '60549c63a2b3b4fb7c24bb34';
        const copiesOfOwnersIDs = '5ab0cdb53efed8141436959b';
        const proofOfBusinessAddress = '5b2a54ecb958c008605883ff';
        const beeCertificate = '60549db9e3032aa608a98cc1';
        const bankStatementsForBusinessAccount = '5aaf6d193a022727ec3b587b';
        const cashFlowProjections = '5ab0ce1d3efed814143695a1';
        const statementOfAssetsAndLiabilities = '5ab0cdd73efed8141436959d';
        const taxClearanceCertificate = '5ab0cdc33efed8141436959c';
        const businessPlan = '5ab0cde13efed8141436959e';
        const latestManagementAccounts = '5ab0cdfc3efed814143695a0';
        const latestAnnualFinancialStatements = '5ab0cded3efed8141436959f';
        ...
        function initControls() {
            ...
            _controlMap.set(financialyearend, { control: app.control.select(financialyearend), parentId: '616d6e53668f1708a649134b' });
            ...
            _controlMap.set(ownerscontribution, { control: app.control.input(ownerscontribution, 'owners-contribution'), parentId: '' });
            _controlMap.set(sourceoffunds, { control: app.control.select(sourceoffunds), parentId: '616d727f668f1708a6491358' });
            ...
            // Documentation ( _StepDocumentation.cshtml )
            _controlMap.set(cipcRegistrationDoc, { control: app.control.radio(cipcRegistrationDoc), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(cipcAnnualReturn, { control: app.control.radio(cipcAnnualReturn), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(copiesOfOwnersIDs, { control: app.control.radio(copiesOfOwnersIDs), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(proofOfBusinessAddress, { control: app.control.radio(proofOfBusinessAddress), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(beeCertificate, { control: app.control.radio(beeCertificate), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(bankStatementsForBusinessAccount, { control: app.control.radio(bankStatementsForBusinessAccount), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(cashFlowProjections, { control: app.control.radio(cashFlowProjections), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(statementOfAssetsAndLiabilities, { control: app.control.radio(statementOfAssetsAndLiabilities), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(taxClearanceCertificate, { control: app.control.radio(taxClearanceCertificate), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(businessPlan, { control: app.control.radio(businessPlan), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(latestManagementAccounts, { control: app.control.radio(latestManagementAccounts), parentId: '5aaf6cfd3a022727ec3b5879' });
            _controlMap.set(latestAnnualFinancialStatements, { control: app.control.radio(latestAnnualFinancialStatements), parentId: '5aaf6cfd3a022727ec3b5879' });
            ...
            _controls.ownerscontribution.val('');
            _controls.ownerscontribution.format(20);
        }
        ...
        function showFinancialInfoControls(cb) {
            ...
            function showFinancialYearEndControl() {
                _controls.financialyearend.show(true);
                cb(_controls.financialyearend);
            }
        ...
        function showFundingRequirementControls(cb) {
            ...
            function showOwnersContributionControl() {
                _controls.ownerscontribution.show(true);
                cb(_controls.ownerscontribution);
            }

            function showSourceOfFundsControl() {
                _controls.sourceoffunds.show(true);
                cb(_controls.sourceoffunds);
            }
            ...
            showOwnersContributionControl();
            showSourceOfFundsControl();
        }

        function showDocumentationControls(cb) {
        ...
        let init = function (application, cb) {
            ...
            showDocumentationControls(addControl);
            cb(AddStatus());
        }
        ...
        function enumDocumentation(cb) {
            showDocumentationControls(function (control) {
                let obj = _controlMap.get(control.name);
                cb(control, obj == null ? '' : obj.parentId);
            });
        }
        ...
        controls.enumDocumentation = enumDocumentation;
