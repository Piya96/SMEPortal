...
{
    public class PortalDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            ...
            public class Sme
            {
                public const string DailySales = "Widgets_Sme_DailySales";
            }
            public class Tenant
            {
                public const string GeneralStats = "Widgets_Tenant_GeneralStats";
                public const string DailyRegistrations = "Widgets_Tenant_DailyRegistrations";
        ...
        {
            public const string DefaultSmeDashboard = "SmeDashboard";
