...
(function (summary) {
    ...
    class DtoSummary_ECDC extends dto.DtoToHtml_ECDC {
    //class DtoSummary_ECDC extends app.wizard.financialInfo.summary.DtoSummary {
        constructor(self) {
            super(self);
            this.appId = null;
            this.root = null;
    ...
    function Render(dto, appId) {
        let summary = new DtoSummary_ECDC(null);
