...
(function (controller) {
    ...
    class AppController extends app.wizard.controller.Controller {
        ...
        getEnquiryNumber(application, cb) {
            ...
            function isValid(enquiryNumber) {
                if (enquiryNumber.length == 9) {
                    let lo = enquiryNumber.slice(0, 3);
                    let hi = enquiryNumber.slice(3, 9);
                    if (lo == 'ENQ' && hi != '000000') {
                        return true;
                    } else {
                        return false;
            ...
            function requestEnquiryNumber(cb) {
                abp.services.app.sefaLAS.requestEnquiryNumber(self.model.application.application.id).done((payload) => {
                    ...
                    if (isValid(result.data.enquiryNumber) == false) {
        ...
        updateUserJourneyProp(page, prop) {
            ...
            function getApplicationProp() {
                ...
                prop.application.push({
                    ...
                    page: controller.Pages.MandateFit
                })
            ...
            if (app.page != null && app.page >= page) {
                ...
                app.page = page;
                switch (page) {
                    case controller.Pages.Disclaimer:
                    case controller.Pages.MandateFit:
                        app.stage = 'FundingRequirements';
                        break;

                    case controller.Pages.FundingRequirements:
                        app.stage = 'CompanyInfo';
                        break;

                    case controller.Pages.LegalQuestions:
                        app.stage = 'FinancialInfo';
                        break;

                    case controller.Pages.DocumentUpload:
