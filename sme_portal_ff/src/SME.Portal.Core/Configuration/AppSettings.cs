namespace SME.Portal.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        public static class UserManagement
        {
            ...
            public const string DefaultUserEditionId = "App.UserManagement.DefaultUserEditionId"; 
        }
        ...
        public static class FinfindApi
        {
            public const string AzureApiGateway = "Finfind.AzureApiGateway";
        }
