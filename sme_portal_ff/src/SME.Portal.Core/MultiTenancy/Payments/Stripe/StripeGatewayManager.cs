...
{
    public class StripeGatewayManager : PortalServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Portal";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PortalConsts.Currency;
        }
