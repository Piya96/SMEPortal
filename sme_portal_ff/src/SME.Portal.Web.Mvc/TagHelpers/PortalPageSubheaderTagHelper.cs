...
namespace SME.Portal.Web.TagHelpers
{
    ...
    public class PortalPageSubheaderTagHelper : TagHelper
    {
        ...
        public PortalPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
