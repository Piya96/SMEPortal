...
using SME.Portal.MultiTenancy.HostDashboard;
...
namespace SME.Portal.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PortalDbContext context, SubscriptionPayment subscriptionPayment)
        {
