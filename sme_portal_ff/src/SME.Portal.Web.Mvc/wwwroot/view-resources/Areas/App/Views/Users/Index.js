(function () {
    $(function () {
        ...
        var _applicationsAppService = abp.services.app.applications;
        var _applicationAppServiceExt = abp.services.app.applicationAppServiceExt;
        var _userTestAccountResetAppService = abp.services.app.userTestAccountReset;
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                _dynamicPropertiesModal.open({
                                    entityFullName: 'SME.Portal.Authorization.Users.User',
                            ...
                            action: function (data) {
                                _applicationAppServiceExt.hubSpotStartSync(
                                    data.record.id
                                ).done(function (data) {
                                    abp.notify.success('Sync Started', "HubSpot");
                                });
                            }
                        }, {
                            text: "Account Reset",
                            ...
                            action: function (data) {
                                _userTestAccountResetAppService.resetAccountStartSync(
                                    data.record.id
                                ).done(function (data) {
                                    console.log(data);
                                    if (data) {
                                        abp.notify.success('Reset Done', "Reset User Account");
                                    } else {
                                        abp.notify.info('Please set reset flag before trying to reset user account.');
                                    }
                                });
                            }
                        }
