...
(function (controller) {
    ...
    class AppController_Hloolo extends app.wizard.controller.AppController {
        constructor(wizardId, bodyId) {
            super(wizardId, bodyId);
            this.name = 'Hloolo App Controller';
        }

        getController() {
            return 'HlooloFunderSearch';
        }
    ...
    controller.create = function (wizardId, bodyId) {
        return new AppController_Hloolo(wizardId, bodyId);
    }
