...
using SME.Portal.Auditing.Exporting;
using SME.Portal.Authorization;
using SME.Portal.Authorization.Users;
using SME.Portal.Dto;
using SME.Portal.EntityHistory;
using EntityHistoryHelper = SME.Portal.EntityHistory.EntityHistoryHelper;

namespace SME.Portal.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PortalAppServiceBase, IAuditLogAppService
    {
