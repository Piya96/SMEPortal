    ...
    (function (businessOwners) {
        ...
        function populate(matchCriteria) {
            for (let jsonName in matchCriteria) {
                ...
                if (obj != null) {
                    let value = matchCriteria[jsonName];
        ...
        function attention(from, to, foreward, cb) {
            ...
            if (companyDto.dto != null) {
                ...
                if (propObj.hasOwnProperty('matchCriteriaJson') == true && propObj.matchCriteriaJson != null) {
                    dtoToForm(propObj.matchCriteriaJson);
                }
        ...
        //$('#id-div-black-only').hide();
        //$('#id-div-women-pdi').hide();
        //$('#id-div-women-black-only').hide();
        //
        //// Show / hide id-div-black-only
        //$('#id-input-black-coloured-indian-pdi').on('input', function (event) {
        //    if (IsANumber(event.target.value)) {
        //        if (event.target.value > 0) {
        //            $('#id-div-black-only').show();
        //        } else {
        //            $('#id-div-black-only').hide();
        //        }
        //    } else {
        ...
        //    }
        //});
        //// Show / hide id-div-women-pdi
        //$('#id-input-women-any-race').on('input', function (event) {
        //    if (IsANumber(event.target.value)) {
        //        if (event.target.value > 0) {
        //            $('#id-div-women-pdi').show();
        //        } else {
        //            $('#id-div-women-pdi').hide();
        //        }
        //    } else {
        ...
        //    }
        //});
        //// Show / hide id-div-women-black-only
        //$('#id-input-women-any-race').on('input', function (event) {
        //    if (IsANumber(event.target.value)) {
        //        if (event.target.value > 0) {
        //            $('#id-div-women-black-only').show();
        //        } else {
        //            $('#id-div-women-black-only').hide();
        //        }
        //    } else {
