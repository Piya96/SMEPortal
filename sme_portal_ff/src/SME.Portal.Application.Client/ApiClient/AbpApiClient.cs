...
namespace SME.Portal.ApiClient
{
    public class AbpApiClient : ISingletonDependency, IDisposable
    {
        ...
        private void AddHeaders(string accessToken)
        {
            ...
            _client.WithHeader("User-Agent", PortalConsts.AbpApiClientUserAgent);
        ...
        private static async Task<T> ValidateAbpResponse<T>(Task<HttpResponseMessage> httpResponse,
            bool stripAjaxResponseWrapper)
        {
