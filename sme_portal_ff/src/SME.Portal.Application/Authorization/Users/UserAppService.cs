...
using SME.Portal.Authorization.Users.Exporting;
...
namespace SME.Portal.Authorization.Users
{
    ...
    public class UserAppService : PortalAppServiceBase, IUserAppService
    {
		...
		public async Task<User> GetUserByTenantAndEmailAndPassword(
			int TenantId,
			string emailAddress,
			string password
		)
