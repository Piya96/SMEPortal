...
using SME.Portal.DemoUiComponents.Dto;

namespace SME.Portal.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PortalAppServiceBase, IDemoUiComponentsAppService
    {
