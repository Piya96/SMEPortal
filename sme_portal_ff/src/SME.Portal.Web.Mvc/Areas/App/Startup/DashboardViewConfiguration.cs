        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(PortalDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                new WidgetFilterViewDefinition(
                    ...
                    jsAndCssFileRoot + "DateRangeFilter/DateRangeFilter.js",
                    jsAndCssFileRoot + "DateRangeFilter/DateRangeFilter.css")
            );
            ...
            #region SmeWidgets
            WidgetViewDefinitions.Add(PortalDashboardCustomizationConsts.Widgets.Sme.DailySales,
                new WidgetViewDefinition(
                    PortalDashboardCustomizationConsts.Widgets.Sme.DailySales,
                    viewFileRoot + "DailySalesSme.cshtml",
                    jsAndCssFileRoot + "DailySalesSme/DailySalesSme.js",
                    jsAndCssFileRoot + "DailySalesSme/DailySalesSme.css"));
            #endregion

            #region TenantWidgets

            WidgetViewDefinitions.Add(PortalDashboardCustomizationConsts.Widgets.Tenant.DailyRegistrations,
                new WidgetViewDefinition(
                    PortalDashboardCustomizationConsts.Widgets.Tenant.DailyRegistrations,
                    viewFileRoot + "DailyRegistrations.cshtml",
                    jsAndCssFileRoot + "DailyRegistrations/DailyRegistrations.js",
                    jsAndCssFileRoot + "DailyRegistrations/DailyRegistrations.css"));
